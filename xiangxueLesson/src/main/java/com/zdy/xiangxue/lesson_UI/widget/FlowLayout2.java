...
public class FlowLayout2 extends ViewGroup {
    ...
    public FlowLayout2(@NonNull Context context) {
        super(context);
    }

    public FlowLayout2(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public FlowLayout2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
