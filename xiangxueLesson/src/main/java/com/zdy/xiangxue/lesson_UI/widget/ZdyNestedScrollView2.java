 ...
 * 作者：zhudongyong
 */
public class ZdyNestedScrollView2 extends NestedScrollView {

    private static final String TAG = ZdyNestedScrollView2.class.getSimpleName();

    private View topView;
    private ViewGroup contentView;
    public ZdyNestedScrollView2(Context context) {
        this(context, null);
        init();
    }

    public ZdyNestedScrollView2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
        init();
    }

    public ZdyNestedScrollView2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
        init();
    }

    public ZdyNestedScrollView2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
